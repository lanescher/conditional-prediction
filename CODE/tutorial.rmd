...
Now we'll work through an example using real data from the [Breeding Bird Survey](https://www.pwrc.usgs.gov/bbs/) (BBS). You can download the process BBS data and covariates from (XX).
